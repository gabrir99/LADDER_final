...
def hypertune(f: TextIO, rf: TextIO):
    """
    Fine tunning of an entity extraction model that just needs to recognize if words are part of an attack pattern or not.
    ...
    for oneConfig in permutations_dicts:
        ...
        for seed in range(1, 2):
            ...
            os.fsync(f)
            try:
                classifier = train_entity_extraction_refactored.EntityClassification(
                    arg
                )
