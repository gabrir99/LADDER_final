...
class SubjectVerbObjectExtractor(object):
    def __init__(self, nlp) -> None:
        """
        Used by the Semantic Role Label component to extract
        (subject, verb, object) for each sentence
                    ...
                    for sub in subs:
                        for obj in objs:
                            ...
                            if is_pas:  # reverse object / subject for passive
                                svos.append(
                                    (
                                        self.to_str(self.expand(obj, tokens, visited)),
                                        "!" + v.lemma_
                                        if verbNegated or objNegated
                                        else v.lemma_,
                                        self.to_str(self.expand(sub, tokens, visited)),
                                    )
                                )
                                svos.append(
                                    (
