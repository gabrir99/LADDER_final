...
class iocs(object):
    ...
    def list_of_iocs(self):
        """
        Extracts indicators of compromise (IOCs) from the given text.

        Parameters:
        self (str): The input string containing potential IOCs.

        Returns:
        list: A list of IOCs extracted from the text.
        """
        ioc_list = []
